...
The main branch (often called `main` or `master`) contains the stable code, while feature branches are used for developing new features or fixing bugs.

The goal here is to never directly commit to the main branch. Instead, create a new branch for your work, make changes there, and then try to do a pull request.

<img src="files/git_workflow.png" alt="Git Workflow" width="600" source="virgilus"/>

But this is just one way to use Git. Different teams may have different workflows.
